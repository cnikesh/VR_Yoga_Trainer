...
def write_json(jsonPath,lockPath,jsonData):
...
def compare_pose(image,angle_point,angle_user, angle_target ):
    ...
    if angle_user[0] < (angle_target[0] - 15):
        ...
        stage = stage + 1
        steps[0] = "Extend the right arm at elbow"
    ...
    if angle_user[0] > (angle_target[0] + 15):
        ...
        stage = stage + 1
        steps[1] = "Fold the right arm at elbow"
    ...
    if angle_user[1] < (angle_target[1] -15):
        ...
        stage = stage + 1
        steps[2] = "Extend the left arm at elbow"
    ...
    if angle_user[1] >(angle_target[1] + 15):
        ...
        stage = stage + 1
        steps[3] = "Fold the left arm at elbow"
    ...
    if angle_user[2] > (angle_target[2] + 15):
        ...
        stage = stage + 1
        steps[5] = "Put your arm down a little"
    ...
    if angle_user[3] > (angle_target[3] + 15):
        #print("Put your arm down a little")
        stage = stage + 1
        steps[7] = "Put your arm down a little"
    ...
    if angle_user[4] < (angle_target[4] - 15):
        ...
        stage = stage + 1
        steps[8] = "Extend the angle at right hip"
    ...
    if angle_user[4] > (angle_target[4] + 15):
        ...
        stage = stage + 1
        steps[9] = "Reduce the angle of at right hip"
    ...
    if angle_user[5] < (angle_target[5] - 15):
        ...
        stage = stage + 1
        steps[10] = "Extend the angle at left hip"
    ...
    if angle_user[5] > (angle_target[5] + 15):
        ...
        stage = stage + 1
        steps[11] = "Reduce the angle at left hip"
    ...
    if angle_user[6] < (angle_target[6] - 15):
        ...
        stage = stage + 1
        steps[12] = "Extend the angle of right knee"
    ...
    if angle_user[6] > (angle_target[6] + 15):
        ...
        stage = stage + 1
        steps[13] = "Reduce the angle at right knee"
    ...
    if angle_user[7] < (angle_target[7] - 15):
        ...
        stage = stage + 1
        steps[14] = "Extend the angle at left knee"
    ...
    if angle_user[7] > (angle_target[7] + 15):
        ...
        stage = stage + 1
        steps[15] = "Reduce the angle at left knee"
    ...
    poseData = {
        "pose_name":"Tree Pose",
        "score":89,
        "angles":[12,10,102,40,10,40,20,40,50,60],
        "steps": steps
    }

    write_json("Pose_Data.json",'lock.txt',poseData)
